...
namespace Dirt4ModInstaller;

internal static class Program
{
    private const string DefaultServer = "142.93.206.37";
    private const string DefaultGamePath = @"C:\Program Files (x86)\Steam\steamapps\common\DiRT 4";
    ...
    private static string DetectGamePath()
    {
        ...
        {
            candidates.Add($@"{drive}:\SteamLibrary\steamapps\common\DiRT 4");
            candidates.Add($@"{drive}:\Program Files (x86)\Steam\steamapps\common\DiRT 4");
            candidates.Add($@"{drive}:\Program Files\Steam\steamapps\common\DiRT 4");
        }
...
internal sealed class InstallerForm : Form
{
    ...
    {
        Text = "EgoNet Revival - DiRT 4 Installer";
        ...
        {
            Text = "Select the DiRT 4 installation folder, then install the RaceNet restoration mod.",
            AutoSize = true,
    ...
    private void BrowseGameFolder()
    {
        ...
        {
            Description = "Select your DiRT 4 installation folder",
    ...
    private async Task InstallAsync()
    {
        ...
        try
        {
            ...
            var installer = new Dirt4Installer(server, gamePath, Log);

            await Task.Run(installer.Install);

            MessageBox.Show(
                "Done. Open DiRT 4 and enter RaceNet.",
                "EgoNet Revival",
                MessageBoxButtons.OK,
...
internal sealed class Dirt4Installer(string server, string gamePath, Action<string> log)
{
    ...
    private void ValidateGameFolder()
    {
        ...
        {
            throw new FileNotFoundException("DiRT 4 executables were not found in: " + gamePath);
        }
    }
    ...
    private void CloseGameIfRunning()
    {
        ...
        log("Closing DiRT 4 before patching...");
    ...
    private void UpdateHostsFile()
    {
        ...
        foreach (var line in File.ReadAllLines(hostsPath))
        {
            ...
            if (trimmed.Equals("# EgoNet Revival DiRT 4", StringComparison.OrdinalIgnoreCase))
            {
                continue;
            }
        ...
        cleanHosts.Add("");
        cleanHosts.Add("# EgoNet Revival DiRT 4");
