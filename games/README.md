...
| DiRT 4 | `games/dirt-4` | `dirt-4-v` | `EgoNet Revival - DiRT 4 Installer.exe`, `install-dirt-4-mod.cmd` |
...
DiRT 4 is in public testing with Community Events enabled, persistent calendar
rotations and results. Pro Tour remains experimental; Jam Session uses Steam
